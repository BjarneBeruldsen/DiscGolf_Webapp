...
const Turneringerliste = () => {
  ...
  return (
    <div className="h-[100vh] p-6 bg-gray-100">
      <h1 className="text-3xl font-bold text-center mb-6 text-gray-800">Turneringer</h1>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-2 gap-6">
          {turneringer.length > 0 ? (
            turneringer.map((turnering) => (
              ...
              >
                ...
                <p className="text-gray-600 mb-1">
                  <strong>Dato:</strong> {turnering.dato}
                </p>
                <p className="text-gray-600 mb-1">
                  <strong>Bane:</strong> {turnering.bane}
                </p>
                <p className="text-gray-600 mb-4">
                  <strong>Beskrivelse:</strong> {turnering.beskrivelse}
                </p>
            ...
            <p className="text-center text-gray-500 col-span-full">Ingen turneringer funnet.</p>
          )}
        </div>
      )}
    </div>

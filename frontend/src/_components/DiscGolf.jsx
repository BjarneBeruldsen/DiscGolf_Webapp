  ...
  return (
    <div className="min-h-screen bg-white py-8">
      <div className="max-w-4xl mx-auto p-8">
        <h1 className="text-3xl font-bold text-center mb-6">Hva er DiscGolf?</h1>
        <section className="space-y-6">
          <div>
            <p className="text-gray-700">
              DiscGolf, også kjent som frisbeegolf, er en sport der man kaster en disc (frisbee) mot en metallkurv. 

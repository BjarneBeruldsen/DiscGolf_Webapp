      ...
      <header className="flex items-center justify-between p-4 bg-[#ffffff] shadow-[#8a8358] text-white">
        ...
        <nav className="hidden-lg">
          <ul className="flex space-x-6">
            ...
            {loggetInnBruker && <li><Link to="/MinePoengtavler" className="text-black font-bold hover:text-gray-600">Min statistikk</Link></li>}
      ...
      {menyÅpen && (
        <nav className="lg:hidden bg-white border-t border-gray-300 border-b">
          <ul className="flex flex-col space-y-4 p-4">
            ...
            {loggetInnBruker && <li><Link to="/MinePoengtavler" className="text-black font-bold hover:text-gray-600" onClick={lukkMeny}>Min statistikk</Link></li>}

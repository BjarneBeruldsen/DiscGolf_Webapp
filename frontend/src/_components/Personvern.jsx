...
const Personvern = () => {
    return (
        <div className="p-6 max-w-3xl mx-auto">
            ...
            <p className="mb-4"><strong>Sist oppdatert:</strong> 17.04.2025</p>
            ...
            <p className="mb-4">
                ...
                <a href="https://disk-applikasjon-39f504b7af19.herokuapp.com/" className="text-blue-600 underline ml-1">
            ...
            <ul className="list-disc pl-6 mt-2">
                ...
                <li>
                    ...
                    <a href="/informasjonskapsler" className="text-blue-600 underline ml-1">Informasjonskapsler</a>
                </li>
            </ul>
            ...
            <p className="mt-2">
                ...
                <a href="mailto:DiscgolfBø@gmail.com" className="text-blue-600 underline ml-1">DiscgolfBø@gmail.com</a>
            </p>
